...
// src/routes/create-short-link.routes.ts
import z from "zod";
var createShortLinkRoute = async (app) => {
  app.post(
    "/links",
    {
      schema: {
    ...
    async (req, reply) => {
      ...
      switch (error.constructor.name) {
        ...
        case "PoorlyFormattedShortUrlError":
          return reply.status(400).send({ message: "Short URL poorly formatted." });
